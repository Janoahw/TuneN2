    ...
    <Layout>
      <div className="max-w-7xl">
        <div className="mb-8">
          ...
          <p className="text-[#8E8E93] mt-2">View and manage all platform users</p>
        </div>
        ...
        <div className="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <select
            ...
            className="px-4 py-2 border border-[#1A1A1E] bg-[#111114] text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00CCCC]"
          >
